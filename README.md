...
当前包含通风风管水力计算、空调水系统水力计算、空调末端设备初步选型和冷热源设备初步选型四个模块，支持 CSV、Excel 和 Word 计算说明书导出，适合课程设计辅助核算、工程初步估算和个人作品集展示。
...
- CSV / Excel 导出
- Word 计算说明书导出已统一基础结构，包含模块说明、输入参数、计算结果、系统汇总、公式说明和免责声明
